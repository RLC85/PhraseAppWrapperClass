...
class phrase_app_api
{
     ...
     * @param String $email - the PhraseApp email used to log in.
     * @return VOID
     */
     ...
     *
     * @author Richard Christensen
     * @param String $password - the PhraseApp password used to log in.
     * @return VOID
     */
     ...
     *
     * @author Richard Christensen
     * @param String $project_auth_token - sets the classes project_auth_token to the provided token.
     * @return VOID
     */
     ...
     *
     * @author Richard Christensen
     * @param String $base_url - sets the base url
     * @return VOID
     */
     ...
     *
     * @author Richard Christensen
     * @param string $email - optional way to pass email to log_in() function
     * @param String $password - optional way to pass password to log_in() function
     * @param String $project_auth_token - optional way to pass project_auth_token to log_in function
     ...
     * query
     * 
     * Main query function to get data from PhraseApp
     *
     * @author Richard Christensen
     * @param String url - url path to the PhraseApp API request
     * @param String $method - GET,POST
     * @param Arrray $args - Data to be passed to PhraseApp as url prameters
     * @return Return Value
     */
